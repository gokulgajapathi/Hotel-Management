...
class Hotel
{
    ...
    static void CustDetails(int i,int rn)
    {
        ...
        while((!(contact.length() == 10)) & (!contact.equals(48) || !contact.equals(49) || !contact.equals(50) || !contact.equals(51) ||
        		...
        		!contact.equals(57) )) {
        	System.out.println("Try again! Enter 10 digits contact number");
        	contact=sc.next();
        }
        ...
        while(!gender.equalsIgnoreCase("male") || gender.equalsIgnoreCase("female")) {
        	System.out.println("Try again! Enter male/female contact number");
        	gender = sc.next();
        }
        if(i<3)
        {
        ...
        System.out.print("Enter contact number: ");
        contact2=sc.next();
        while((!(contact2.length() == 10)) & (!contact2.equals(48) || !contact2.equals(49) || !contact2.equals(50) || !contact2.equals(51) ||
        		!contact2.equals(52) || !contact2.equals(53) || !contact2.equals(54) || !contact2.equals(55) || !contact2.equals(56) ||
        		!contact2.equals(57) )) {
        	System.out.println("Try again! Enter 10 digits contact number");
        	contact2=sc.next();
        }
